  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center items-center p-4">
      ...
      <div className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-2xl p-8 shadow-xl">
        <h1 className="text-2xl font-bold text-slate-100 mb-6 text-center">Begin Your Journey</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-slate-400 mb-1">Hero Name</label>
            <input
              type="text"
              required
              value={displayName}
          ...
          >
            {isLoading ? 'Creating Hero...' : 'Create Account'}
          </button>
        </form>
