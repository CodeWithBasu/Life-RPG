      ...
      >
        ...
        <form onSubmit={handleSubmit} className="w-full flex flex-col gap-3.5">
          ...
          <div className="relative">
            <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
              <User className="w-5 h-5 text-slate-400 dark:text-indigo-400" />
            </div>
            <input 
              type="text" 
              placeholder="Hero Name (e.g. Aragorn)"
              required
              value={displayName}
        ...
        <div className="mt-8 text-center">
          <p className="text-[14px] font-medium text-slate-500 dark:text-indigo-300">
            Already have an account? <Link href="/login" className="font-extrabold text-[#3b82f6] hover:text-blue-600 transition-colors">Log In</Link>
          </p>
